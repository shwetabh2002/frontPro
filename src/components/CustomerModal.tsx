...
const CustomerModal: React.FC<CustomerModalProps> = ({ isOpen, onClose, prePopulatedData, mode = 'add', allowCustomerCreation = false, showBookingAmount = false, quotationStatus = 'pending', onQuotationCreated }) => {
  ...
  useEffect(() => {
    if (prePopulatedData && isOpen) {
      ...
      setSelectedCountryCode(prePopulatedData.countryCode);
    }
              ...
              <div className="flex space-x-4 pt-6 border-t border-slate-200">
                ...
                >
                  {isCreatingQuotation ? (
                    <>
                      ...
                      {showBookingAmount ? 'Creating Order...' : 'Creating Quotation...'}
                    </>
                  ) : (
                    <>
                      ...
                      {showBookingAmount ? 'Save Order' : 'Save Quotation'}
                    </>
                  )}
                </button>
                <button
                ...
                >
                  <svg className="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   ...
                   {showBookingAmount ? 'Cancel Order' : 'Cancel Quotation'}
                </button>
              </div>
            </div>
          )}
