      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl border border-blue-500/30 max-w-6xl w-full max-h-[95vh] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="p-8 overflow-y-auto max-h-[calc(95vh-140px)]">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* VIN Number Section - Only for cars (single VIN per car) */}
            {formData.type === 'car' && (
              <div className="space-y-6">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="p-2 bg-blue-500/20 rounded-lg">
                  ...
                  <h3 className="text-xl font-semibold text-blue-400">VIN Number</h3>
                  {/* Multi-VIN: Uncomment below to show quantity badge
              ...
              <div className="space-y-3">
                {/* Single VIN Input */}
                <div className="p-3 bg-gray-800/30 rounded-xl border border-gray-600/50">
                ...
                {/* Multi-VIN: Uncomment below to enable multiple VIN inputs
