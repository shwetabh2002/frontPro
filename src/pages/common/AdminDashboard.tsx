      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center">
          ...
          <div className="flex flex-col">
            <h1 className="text-2xl font-bold text-gray-900 m-0 p-0 text-left">
              Dashboard
            </h1>
            ...
            <div className="relative p-6">
              ...
              <div className="mt-4 flex items-end space-x-1 h-12">
                {stat.trend.map((value, i) => (
                  <div
                    key={i}
                    className="flex-1 bg-gradient-to-t from-blue-500/60 to-blue-400/30 rounded-sm hover:from-blue-600/80 hover:to-blue-500/50 transition-all duration-200"
      ...
      <div className="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-6 py-5">
          <div className="flex items-center mb-5">
            <div className="p-2 bg-blue-50 border border-blue-200 rounded-lg mr-3">
          ...
          <div className="overflow-hidden rounded-xl">
            ...
            <div className="bg-white">
              {recentOrders.map((order) => (
                <div key={order.id} className="grid grid-cols-6 gap-0 hover:bg-gray-50 transition-all duration-200 border-b border-gray-100">
                  <div className="px-5 py-4 text-sm font-bold text-gray-900">
                    {order.id}
                  </div>
                  <div className="px-5 py-4 text-sm font-medium text-gray-700">
                    {order.customer}
                  </div>
                  <div className="px-5 py-4 text-sm font-bold text-gray-900">
                    {order.amount}
        ...
        <div className="px-6 py-5">
          ...
          <div className="space-y-4">
            {recentActivities.map((activity, index) => (
              <div key={index} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg border border-gray-200 hover:shadow-sm transition-all duration-200">
        ...
        <div className="px-6 py-5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            {quickActions.map((action, index) => (
              <button key={action.name} className="group p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-md transition-all duration-200 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <p className="text-sm font-bold text-gray-900 mb-1">{action.name}</p>
