...
const ExpensesPage: React.FC = () => {
  ...
  const { canApproveExpenses, canEditApprovedExpenses, canDeleteApprovedExpenses } = usePermissions();
                  ...
                  <tr key={expense.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        {(expense.status !== 'approved' || canEditApprovedExpenses()) && (
                          <button 
                        ...
                        {(expense.status !== 'approved' || canDeleteApprovedExpenses()) && (
                          <button 
