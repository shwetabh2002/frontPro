...
interface MenuItem {
  ...
  pageKey: string; // Key to match with RBAC page permissions
}
...
const AdminLayout: React.FC = () => {
  ...
  const menuItems = useMemo(() => {
    return allMenuItems.filter(item => canAccessPage(item.pageKey as any));
  }, [canAccessPage]);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-3 py-1.5 text-sm text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
